...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of JSAsyncExecution.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Json/JSAsyncExecution'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Json' => '1595371165@qq.com' }
  s.source           = { :git => 'https://github.com/Json/JSAsyncExecution.git', :tag => s.version.to_s }
